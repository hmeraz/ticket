package com.axity.ticket.commons.aspectj;
...
public class JsonResponseHandlerInterceptor implements HandlerInterceptor
{
   ...
   * 
   */
  @Around("execution (* com.axity.ticket.controller.*.*(..))"
      + " and @annotation(com.axity.ticket.commons.aspectj.JsonResponseInterceptor)")
